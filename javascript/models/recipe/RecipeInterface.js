...
RecipeInterface.prototype.fetchIndex = function(http) {
...
RecipeInterface.prototype.fetchForView = function(http, recipeId) {
...
RecipeInterface.prototype.fetchForEdit = function(http, recipeId) {
...
//@http: The AngularJS $http service used to make the request
RecipeInterface.prototype.create = function(http, newRecipe) {
...
RecipeInterface.prototype.update = function(http, recipe) {
	var updateUrl = 'http://localhost/MenuList/recipes/edit/' + recipe.id + '.json';

	return http.post(updateUrl, recipe);
};

RecipeInterface.prototype.delete = function(http, recipeId) {
